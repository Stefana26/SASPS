...
function searchRooms() {
    ...
    const response = http.post(`${ROOM_BASE}/rooms/search`, payload, params);
...
function getAllHotels() {
    ...
    const response = http.get(`${ROOM_BASE}/hotels`, params);
...
function getHotelById(id = 1) {
    ...
    const response = http.get(`${ROOM_BASE}/hotels/${id}`, params);
...
function getRoomsByHotel(hotelId = 1) {
    ...
    const response = http.get(`${ROOM_BASE}/rooms/hotel/${hotelId}`, params);
...
function getAllBookings() {
    ...
    const response = http.get(`${BOOKING_BASE}/bookings`, params);
